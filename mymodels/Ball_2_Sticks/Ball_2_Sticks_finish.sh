...
Usage() {
    echo ""
    echo "Usage: Ball_2_Sticks_finish.sh <subject_directory>"
    echo ""
...
mv $directory/Param_2_samples.nii.gz $directory/f1_samples.nii.gz
mv $directory/Param_3_samples.nii.gz $directory/th1_samples.nii.gz
mv $directory/Param_4_samples.nii.gz $directory/ph1_samples.nii.gz
mv $directory/Param_5_samples.nii.gz $directory/f2_samples.nii.gz
mv $directory/Param_6_samples.nii.gz $directory/th2_samples.nii.gz
mv $directory/Param_7_samples.nii.gz $directory/ph2_samples.nii.gz
