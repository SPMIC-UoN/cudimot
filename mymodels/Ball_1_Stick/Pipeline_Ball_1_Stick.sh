...
echo ${PathDTI}/dtifit_L1.nii.gz >> $InitializationFile # d
...
postproc=`${bindir}/jobs_wrapper.sh ${subjdir}.${modelname} $dtifitProcess $modelname FitProcess $njobs $ModelOpts`
